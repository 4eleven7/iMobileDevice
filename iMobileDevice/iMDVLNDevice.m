...
@property (nonatomic, strong) iMDVLNLockdowndClient *lockdownClient;
@property (nonatomic, strong) iMDVLNSpringboardClient *springboardClient;
@property (nonatomic, strong) iMDVLNScreenshotrClient *screenshotrClient;
